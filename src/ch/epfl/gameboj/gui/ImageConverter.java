...
public final class ImageConverter {
    ...
    private static final int[] COLOR_MAP_BUFF = new int[] { 0xFF_FF_FF,
            0xD3_D3_D3, 0xA9_A9_A9, 0x00_00_00 };

    public static Image convert(LcdImage other) {

        WritableImage result = new WritableImage(LcdController.LCD_WIDTH,
    ...
    public static BufferedImage Bufferedconvert(LcdImage other) {
        ...
        BufferedImage result = new BufferedImage(other.width(), other.height(),
