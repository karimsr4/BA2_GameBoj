...
public final class Alu {
	...
	public static int shiftRightL(int v) {
		...
		return packValueZNHC(Preconditions.checkBits8(v) >>> 1, v >>> 1 == 0, false, false, Bits.test(v, 0));
	...
	public static int rotate(RotDir d, int v) {
		...
		switch (d) {
		case LEFT:
			result = Bits.rotate(8, Preconditions.checkBits8(v), 1);
			return packValueZNHC(result, result == 0, false, false, Bits.test(v, 7));
		default:
			result = Bits.rotate(8, Preconditions.checkBits8(v), -1);
			return packValueZNHC(result, result == 0, false, false, Bits.test(v, 0));
	...
	public static int swap(int v) {
		...
		return Bits.extract(Preconditions.checkBits8(v), 4, 0) | Bits.clip(4, Preconditions.checkBits8(v)) << 4;
