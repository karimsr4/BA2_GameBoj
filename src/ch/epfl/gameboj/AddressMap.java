...
public interface AddressMap {
    ...
    int REG_IE = 0xFFFF;
    int REG_STAT=REGS_LCDC_START+1;
    int REG_SCY=REGS_LCDC_START+2;
    int REG_SCX=REGS_LCDC_START+3;
    int REG_LY=REGS_LCDC_START+4;
    int REG_LYC=REGS_LCDC_START+5;
    int REG_DMA=REGS_LCDC_START+6;
    int REG_BGP=REGS_LCDC_START+7;
    int REG_OBP0=REGS_LCDC_START+8;
    int REG_OBP1=REGS_LCDC_START+9;
    int REG_WY=REGS_LCDC_START+10;
    int REG_WX=REGS_LCDC_START+11;
}
